-- Chainlit data layer schema (from https://github.com/Chainlit/chainlit-datalayer prisma migrations).
-- Run:  python -m scripts.init_chainlit_db  (creates tables and applies patches on existing DBs)
--
-- metadata columns use DEFAULT '{}'::jsonb because Chainlit's update_thread omits metadata when
-- unset; without a default, PostgreSQL inserts NULL and violates NOT NULL.
